                    ...
                    <div className="overflow-hidden rounded-[2rem] border border-[rgba(255,255,255,0.12)] bg-[var(--color-ink)] text-[var(--color-ivory)] shadow-[0_22px_60px_rgba(23,23,23,0.24)]">
                        ...
                        <div className="flex h-14 items-center justify-between px-5">
                            ...
                            <div className="hidden items-center gap-2 sm:flex">
                                ...
                                <span className="text-[9px] font-medium uppercase tracking-[0.2em] text-[rgba(245,241,232,0.55)]">VENDOR</span>
                            </div>
                            ...
                            <div className="min-h-0 overflow-hidden">
                                <div className="border-t border-[rgba(255,255,255,0.1)] px-5 pb-5 pt-4">
                                    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                                        <IslandItem icon={Home} label="Console" onClick={() => handleNavigation("/vendor")} />
                                        <IslandItem icon={Package} label="Products" onClick={() => handleNavigation("/vendor/products")} />
                                        <IslandItem icon={Boxes} label="Inventory" onClick={() => handleNavigation("/vendor/inventory")} />
                                        <IslandItem icon={ShoppingBag} label="Rentals" onClick={() => handleNavigation("/vendor/rentals")} />
                                    </div>
                                    ...
                                    <div className="mt-5 flex items-center justify-between border-t border-[rgba(255,255,255,0.1)] pt-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[9px] uppercase tracking-[0.15em] text-[rgba(245,241,232,0.45)]">Vendor Space</p>
                                            </div>
                                        </div>
