        ...
        <main className="min-h-screen bg-[var(--color-ivory)] px-6 pb-24 pt-28 sm:pt-32 lg:pt-36 text-[var(--color-ink)]">
            <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div className="flex items-center justify-between border-b border-[var(--color-line-soft)] pb-4">
                    <div>
                        <h1 className="text-3xl font-medium tracking-[-0.04em]">Vendor Rental Orders</h1>
                        <p className="text-xs text-[var(--color-ink-soft)]">Monitor and fulfill customer rental orders.</p>
                    </div>
                </div>
                ...
                {isLoading ? (
                    ...
                    <div className="rounded-2xl border border-[var(--color-line)] bg-white/30 p-12 text-center">
                        ...
                        <h3 className="mt-3 text-base font-medium">No rental orders</h3>
                        <p className="mt-1 text-xs text-[var(--color-muted)]">No active or past customer rental orders found.</p>
                    </div>
                ) : (
