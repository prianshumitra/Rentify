            ...
            <div className="relative z-10 mx-auto max-w-5xl space-y-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-[var(--color-line-soft)] pb-5">
                    <div>
                        ...
                        <p className="mt-1 text-xs leading-5 text-[var(--color-ink-soft)]">
                            Manage product listings, inventory items, and rental transactions.
                        </p>
                    </div>
                ...
                <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                        ...
                        <p className="mt-1 text-[10px] text-[var(--color-muted)]">Active listings</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="mt-1 text-[10px] text-[var(--color-muted)]">Managed units</p>
                    </div>
                    ...
                    >
                        ...
                        <p className="mt-1 text-[10px] text-[var(--color-muted)]">Active orders</p>
                    </div>

                    {/* Revenue */}
                    <div className="group rounded-[1.5rem] border border-white/90 bg-gradient-to-b from-[#faf8f3] via-[#f6f3ea] to-[#f0ebdf] p-5 shadow-[0_12px_30px_rgba(23,23,23,0.06)] backdrop-blur-xl transition-all duration-300">
                        <div className="flex items-center justify-between">
                            <span className="text-[8px] font-bold uppercase tracking-[0.2em] text-[var(--color-muted)]">
                                Gross Earnings
                            </span>
                        ...
                        <p className="mt-1 text-[10px] text-[var(--color-muted)]">Total rental revenue</p>
                    </div>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    ...
                    >
                        <div>
                            ...
                            <h3 className="mt-4 text-lg font-medium text-[var(--color-ink)]">Manage Products</h3>
                            <p className="mt-1 text-xs text-[var(--color-ink-soft)] leading-5">
                                Add, update, or remove rental items in your product catalog.
                            </p>
                        </div>
                    ...
                    >
                        <div>
                            ...
                            <h3 className="mt-4 text-lg font-medium text-[var(--color-ink)]">Inventory Stock</h3>
                            <p className="mt-1 text-xs text-[var(--color-ink-soft)] leading-5">
                                View available physical units, maintenance, and status.
                            </p>
                        </div>
                        <div className="mt-6 flex items-center gap-1.5 text-[8px] font-bold uppercase tracking-[0.2em] text-[var(--color-accent)]">
                    ...
                    >
                        <div>
                            ...
                            <h3 className="mt-4 text-lg font-medium text-[var(--color-ink)]">Rental Orders</h3>
                            <p className="mt-1 text-xs text-[var(--color-ink-soft)] leading-5">
                                Process customer rental fulfillments, returns, and inspections.
                            </p>
                        </div>
                        <div className="mt-6 flex items-center gap-1.5 text-[8px] font-bold uppercase tracking-[0.2em] text-[var(--color-accent)]">
